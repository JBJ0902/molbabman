    ...
    const endingImages = {
      ...
      riceOnly: "assets/endings/clear.png",
      silent: "assets/endings/perfect.png",
      comboMaster: "assets/endings/kimchiKing.png",
      tightrope: "assets/endings/clear.png",
      comeback: "assets/endings/intern.png",
    ...
    const ENDING_DETAILS = {
      ...
      kimchiKing: {
        ...
        galleryDesc: "밥알은 끝까지 남기고 김치만으로 회의를 버텼습니다. 아삭한 집념으로 완성한 김치 단독 클리어입니다."
      },
      riceOnly: {
        title: "밥심 정직원 엔딩",
        shortName: "밥심",
