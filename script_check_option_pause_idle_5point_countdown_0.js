    ...
    const IDLE_STAGE_PREWARN_SECONDS = 10;
    ...
    function showIdleStageNotice({ title = "딴짓 경고", text = "", count = "", mode = "warn", duration = 1800, progress = null, countdownText = "" } = {}) {
      const notice = document.getElementById("idleStageNotice");
      if (!notice) return;
    ...
    function updateIdleStageTimer(dt) {
      ...
      if (remain <= IDLE_STAGE_PREWARN_SECONDS && game.idleEatTimer < IDLE_STAGE_WARNING_SECONDS) {
