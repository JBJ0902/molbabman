    ...
    function caught() {
      ...
      const caughtReason = getCaughtReason();
      const caughtBannerText = getCaughtBannerText(caughtReason);
      ...
      pulseWrap("danger");
      showResultBanner(game.life <= 0 ? "로켓 방출!" : caughtBannerText, "danger", 1100);
      ...
      statusText.textContent = game.life <= 0
        ? (caughtReason === "kimchi" ? "김치 소리 때문에 최종 적발! 로켓에 실려 팀에서 방출됩니다." : "밥 먹는 장면이 최종 적발! 로켓에 실려 팀에서 방출됩니다.")
